...
import dev.sargunv.pokekotlin.model.Genus
import dev.sargunv.pokekotlin.model.GrowthRateExperienceLevel
import dev.sargunv.pokekotlin.model.MoveBattleStylePreference
import dev.sargunv.pokekotlin.model.MoveStatAffect
import dev.sargunv.pokekotlin.model.Name
import dev.sargunv.pokekotlin.model.NamedApiResource
import dev.sargunv.pokekotlin.model.NaturePokeathlonStatAffect
import dev.sargunv.pokekotlin.model.NatureStatChange
import dev.sargunv.pokekotlin.model.PalParkEncounterArea
import dev.sargunv.pokekotlin.model.PokemonAbility
import dev.sargunv.pokekotlin.model.PokemonHeldItemVersion
import dev.sargunv.pokekotlin.model.PokemonMoveVersion
import dev.sargunv.pokekotlin.model.PokemonSpeciesDexEntry
import dev.sargunv.pokekotlin.model.PokemonSpeciesFlavorText
import dev.sargunv.pokekotlin.model.PokemonSpeciesGender
import dev.sargunv.pokekotlin.model.PokemonSpeciesVariety
import dev.sargunv.pokekotlin.model.PokemonStat
import dev.sargunv.pokekotlin.model.PokemonType
import dev.sargunv.pokekotlin.model.TypePokemon
...
class PokemonTest {
  ...
  fun getAbility() = runTest {
    StaticPokeApi.getAbility(1).apply {
      assertEquals(1, id)
  ...
  fun getCharacteristic() = runTest {
    StaticPokeApi.getCharacteristic(1).apply {
      assertEquals(1, id)
  ...
  fun getEggGroup() = runTest {
    StaticPokeApi.getEggGroup(1).apply {
      assertEquals(1, id)
  ...
  fun getGender() = runTest {
    StaticPokeApi.getGender(1).apply {
      assertEquals(1, id)
  ...
  fun getGrowthRate() = runTest {
    StaticPokeApi.getGrowthRate(1).apply {
      assertEquals(1, id)
  ...
  fun getNature() = runTest {
    StaticPokeApi.getNature(10).apply {
      assertEquals(10, id)
  ...
  fun getPokeathlonStat() = runTest {
    StaticPokeApi.getPokeathlonStat(1).apply {
      assertEquals(1, id)
  ...
  fun getPokemon1() = runTest {
    StaticPokeApi.getPokemon(1).apply {
      assertEquals(1, id)
  ...
  fun getPokemon2() = runTest {
    StaticPokeApi.getPokemon(12).apply {
      assertNotNull(
        heldItems.find {
  ...
  fun getPokemon3() = runTest {
    StaticPokeApi.getPokemonEncounterList(12).apply {
      assertNotNull(
  ...
  fun getPokemon4() = runTest {
    StaticPokeApi.getPokemon(399).apply {
      sprites.apply {
  ...
  fun getPokemonColor() = runTest {
    StaticPokeApi.getPokemonColor(1).apply {
      assertEquals(1, id)
  ...
  fun getPokemonForm() = runTest {
    StaticPokeApi.getPokemonForm(1).apply {
      assertEquals(1, id)
      assertEquals("bulbasaur", name)
      assertEquals(1, order)
  ...
  fun getPokemonForm2() = runTest {
    StaticPokeApi.getPokemonForm(10266).apply {
      assertContains(
        formNames,
  ...
  fun getPokemonHabitat() = runTest {
    StaticPokeApi.getPokemonHabitat(1).apply {
      assertEquals(1, id)
  ...
  fun getPokemonShape() = runTest {
    StaticPokeApi.getPokemonShape(1).apply {
      assertEquals(1, id)
  ...
  fun getPokemonSpecies1() = runTest {
    StaticPokeApi.getPokemonSpecies(1).apply {
      assertEquals(1, id)
      assertEquals("bulbasaur", name)
      assertEquals(1, order)
  ...
  fun getPokemonSpecies2() = runTest {
    StaticPokeApi.getPokemonSpecies(2).apply {
  ...
  fun getPokemonSpecies3() = runTest {
    StaticPokeApi.getPokemonSpecies(351).apply {
      assertContains(
        formDescriptions,
        Description(
          description =
