...
class ItemTest {
    ...
    fun getItemAttribute() {
        TestClient.getItemAttribute(3).apply {
            assertEquals(3, id)
    ...
    @Test
    fun getItemCategory() {
        TestClient.getItemCategory(34).apply {
            assertEquals(34, id)
    ...
    fun getItemFlingEffect() {
        TestClient.getItemFlingEffect(1).apply {
            assertEquals(1, id)
    ...
    @Test
    fun getItemPocket() {
        TestClient.getItemPocket(4).apply {
            assertEquals(4, id)
